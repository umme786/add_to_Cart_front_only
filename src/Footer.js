...
const Footer = () => {
    return (
      ...
      <div class="p-6 border-b border-gray-300">
        <div class="mx-auto w-[88%] flex justify-center items-center lg:justify-between">
        ...
        <div class="py-10 text-center md:text-left w-[85%] mx-auto">
          <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="">
              <h6 class=" uppercase font-semibold mb-4 flex items-center justify-center md:justify-start"> <img src="../images/com-logo.png" /> </h6>
              <p>
        ...
        <div class="text-center p-6 bg-gray-200">
          ...
          <a class="text-gray-600 font-semibold" href=""> iNeuron </a>
        </div>
      </div>
      </footer>
        );
